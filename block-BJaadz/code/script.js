...
allHrsArray.forEach((hr) => (hr.style.background = "antiquewhite"));
...
let box1 = document.querySelector(".image");
box1.style.border = "2px solid purple";
...
document.querySelector(".five").style.borderRadius = "1px solid black";
...
let box_1_child = [...box1.childNodes];
box_1_child.forEach((p) =>
  p.tagName == "P" ? (p.style.fontSize = "0.8rem") : null
);

// Change the background of all the alternate boxes (1, 3, 5, ....) to aliceblue
let allBoxes = [...document.querySelectorAll(".box")];
allBoxes.forEach((box, index) =>
  index % 2 == 0 ? (box.style.backgroundColor = "aliceblue") : null
);
...
document.querySelector(".two").classList.add("awesome-box");
...
let a1 = document.createElement("a").innerText("Altcampus");
let a2 = document.createElement("a").innerText("Google");
